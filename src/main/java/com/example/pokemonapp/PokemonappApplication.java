...
public class PokemonappApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		if (dresseurRepository.count() == 0) {
			...
			// --- Création du Dresseur ADMIN ---
			Dresseur admin = new Dresseur();
			...
			System.out.println("Données initiales créées : 1 ADMIN, 3 Dresseurs, 50 Pokémon et 5 Boosters avec 10 cartes chacun !");
		}
	}
}
